    ...
    <View
      ...
      <View
        ...
        <RenderHTML
          ...
          source={{
            html: `<div style="font-size: 38; margin-left: 10px;  margin-right: 10px; font-family: 'Arial', sans-serif; color: black;>${text}</div>`,
          }}
        />
      </View>
      <View style={{height: 5}} />
      ...
      {companyInfo && (
        <ScrollView>
          ...
          <HTML
            ...
            source={companyInfo.keyDevelopments}
          />
          <HTML
            title="Chiến lược kinh doanh"
            source={companyInfo.businessStrategies}
          />
            ...
            <View
              ...
              <View
                ...
                <View style={styles.basicInfoContainer}>
                  ...
                  <Text style={styles.basicInfoTxtValue}>
                ...
                <View style={styles.basicInfoContainer}>
                  <Text style={styles.basicInfoTxtKey}>
                    Số lượng nhân viên:{' '}
                  </Text>
                  <Text style={styles.basicInfoTxtValue}>
                    {companyInfo.noEmployees}
                  </Text>
                </View>
                <View style={styles.basicInfoContainer}>
                  <Text style={styles.basicInfoTxtKey}>Số lượng cổ đông: </Text>
                  <Text style={styles.basicInfoTxtValue}>
                    {companyInfo.noShareholders}
                  </Text>
                </View>
                <View style={styles.basicInfoContainer}>
                ...
                <View style={styles.basicInfoContainer}>
                  <Text style={styles.basicInfoTxtKey}>
                    Tên nghành(Tiếng anh):{' '}
                  </Text>
                  <Text style={styles.basicInfoTxtValue}>
                    {companyInfo.industryEn}
                  </Text>
                </View>
                <View style={styles.basicInfoContainer}>
            ...
            <View
              ...
              <View
                ...
                <View style={styles.basicInfoContainer}>
                  ...
                  <Text style={styles.basicInfoTxtValue}>
                    {companyInfo.outstandingShare} triệu
                  </Text>
                </View>
                <View style={styles.basicInfoContainer}>
                    ...
                    data={[
                      {
                        ...
                        population: parseFloat(
                          (companyInfo.foreignPercent * 100).toFixed(2),
                        ),
                        color: 'orange',
                      },
                      {
                        name: '% Trong nước',
                        population: parseFloat(
                          ((1 - companyInfo.foreignPercent) * 100).toFixed(2),
                        ),
                        color: 'gold',
                      },
                    ]}
  ...
  const getOverviewInfo = async () => {
    try {
      const res = await API_CORE.get<any>(
        `${ROOT_PATH}/invest_mate/api/stock_detail/overview_info`,
        {
          params: {
            code: item.code,
          },
