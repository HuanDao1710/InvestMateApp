...
const extractLableColumn = (listItem : FinancialRatioChartDataDTO[],  yearly : number) : any[] => {
    if(yearly === 0) {
...
const extractEPSChangeData  = (listItem : FinancialRatioChartDataDTO[], yearly : number) : any[] => {
    let lineData : any[];
    if(yearly === 0) {
